...
namespace AppNet.AppService
{
    public interface ISalesService
    {
        ...
        Task<Sale> Update(int SaleID, int StockID, int CustomerID, short ProductPiece, decimal SalePrice, decimal TotalPrice, string SaleDesription, string SaleStatus, string SalePaymentMethod);
