using AppNet.AddCategoryForm;
using AppNet.AddProductForm;
using AppNet.DeleteCategoryForm;
using AppNet.DeletedProductForm;
using AppNet.UpdateCategoryForm;
using AppNet.UpdatedProductForm;

namespace AppNet.ProductForm
{
